...
from .miscmodels import BaseArena, GoldPassSeason, Label, Arena, Location, LoadGameData
...
class Client:
    ...
    def __init__(
        ...
        *,
        key_count: int = 1,
        key_names: str = "Created with cr.py Client",
        ...
        **kwargs,
        ...
        self.key_scopes = ClashAccountScopes.USER.value
        ...
        self.objects_cls = {"Player": Player, "Clan": Clan,
                            "RankedPlayer": RankedPlayer, "RankedClan": RankedClan,
                            "ClanMember": ClanMember, "Location": Location,
                            "Arena": Arena, "BaseArena": BaseArena, "GoldPassSeason": GoldPassSeason,
                            "Label": Label}
    ...
    def set_object_cls(self, name: str, cls):
        ...
        TypeError
            ...
            object name.
        """
        default_cls = {"Player": Player, "Clan": Clan,
                       "RankedPlayer": RankedPlayer, "RankedClan": RankedClan,
                       "ClanMember": ClanMember, "Location": Location,
                       "Arena": Arena, "BaseArena": BaseArena, "GoldPassSeason": GoldPassSeason,
                       "Label": Label}
    ...
    # leagues
    async def search_leagues(self, *, limit: int = None, before: str = None, after: str = None, cls: Type[Arena] = None,
                             **kwargs) -> List[Arena]:
        """Get list of leagues.
        ...
        """
        if cls is None:
            cls = self.objects_cls['Arena']
        if not issubclass(cls, Arena):
            raise TypeError("cls must be a subclass of Arena.")
        data = await self.http.search_leagues(limit=limit, before=before, after=after, **{**self._defaults, **kwargs})
        return [cls(data=n, client=self) for n in data["items"]]

    async def get_league(self, league_id: int, cls: Type[Arena] = None, **kwargs) -> Arena:
        """
    ...
    async def get_league_named(self, league_name: str, cls: Type[Arena] = None, **kwargs) -> Optional[Arena]:
    ...
    async def search_builder_base_leagues(self, *, limit: int = None, before: str = None, after: str = None,
                                          cls: Type[BaseArena] = None, **kwargs)-> List[BaseArena]:
        ...
        Returns
        --------
        List[:class:`BaseArena`]
            The requested leagues.
        """
        if cls is None:
            cls = self.objects_cls['BaseArena']
        if not issubclass(cls, BaseArena):
            raise TypeError("cls must be a subclass of BaseArena.")
        data = await self.http.search_builder_base_leagues(limit=limit, before=before, after=after,
                                                           **{**self._defaults, **kwargs})
        return [cls(data=n, client=self) for n in data["items"]]

    async def get_builder_base_league(self, league_id: int, cls: Type[BaseArena] = None, **kwargs) -> BaseArena:
        """
    ...
    async def get_builder_base_league_named(self, league_name: str, cls: Type[BaseArena] = None, **kwargs) -> Optional[BaseArena]:
    ...
    async def search_war_leagues(self, *, limit: int = None, before: str = None, after: str = None, cls: Type[BaseArena] = None,
                                 **kwargs) -> List[BaseArena]:
    ...
    async def get_war_league(self, league_id: int, cls: Type[BaseArena] = None, **kwargs) -> BaseArena:
        """
    ...
    async def get_war_league_named(self, league_name: str, cls: Type[BaseArena] = None, **kwargs) -> Optional[BaseArena]:
    ...
    async def search_capital_leagues(self, *, limit: int = None, before: str = None, after: str = None, cls: Type[BaseArena] = None,
                                     **kwargs) -> List[BaseArena]:
    ...
    async def get_capital_league(self, league_id: int, cls: Type[BaseArena] = None, **kwargs) -> BaseArena:
        """
    ...
    async def get_capital_league_named(self, league_name: str, cls: Type[BaseArena] = None, **kwargs) -> Optional[BaseArena]:
    ...
    async def get_seasons(self, league_id: int = 29000022, **kwargs) -> List[str]:
        ...
        .. note::
            ...
            Arena season information is available only for Legend Arena, with a league ID 29000022.


        Parameters
        -----------
        league_id : str
            The Arena ID to search for. Defaults to the only league you can get season information for, legends.
        cls:
            Target class to use to model that data returned.
    ...
    async def get_player(self, player_tag: str, cls: Type[Player] = Player,
        ...
        return cls(data=data, client=self, **{**self._defaults, **kwargs})

    def get_players(self, player_tags: Iterable[str], cls: Type[Player] = None,  **kwargs) -> AsyncIterator[
        Player]:
        ...
        return PlayerIterator(self, player_tags, cls=cls, **{**self._defaults, **kwargs} )
